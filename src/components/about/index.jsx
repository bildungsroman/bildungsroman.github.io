    ...
    <>
      <ContainerLayout>
        ...
        <AboutSection id='about'>
          ...
          <Text>
            Hi! My name is Anna Spysz and I used to just write, edit, and translate things for a living—now I also code them (✨ feature upgrade ✨). Sometimes I also <a className="text-primary lined-link" href="https://www.flickr.com/people/fakeplasticgirl/" target="_blank" rel="noreferrer">take pictures</a>, and other times I <a className="text-primary lined-link" href="https://newcenturyclassics.bandcamp.com" target="_blank" rel="noreferrer">make</a> <a className="text-primary lined-link" href="https://open.spotify.com/artist/5VEKmbZzSLVfWP6NrN4hRN" target="_blank" rel="noreferrer">music</a>. Mostly, though, I love to read, learn, and travel.
          </Text>
          <Text>
